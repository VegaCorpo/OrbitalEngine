    ...
    for i in range(num_entities):
        entity = {
            ...
            "components": {
                ...
                "Position": {
                    "x": round(random.uniform(-100000000.0, 100000000.0), 2),
                    "y": round(random.uniform(-100000000.0, 100000000.0), 2),
                    "z": round(random.uniform(-100000000.0, 100000000.0), 2)
                },
                "Velocity": {
...
def parser():
    ...
    parser.add_argument("-n", "--num_entities", type=int, default=10, help="Number of entities to generate")
    parser.add_argument("-o", "--output_file", type=str, default="map.json", help="Output file name for the generated map")
